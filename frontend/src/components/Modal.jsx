...
export default function Modal({ open, title, message, confirmLabel = 'Confirm', cancelLabel = 'Cancel', variant = 'danger', onConfirm, onCancel, hideActions, children }) {
  ...
  const variants = {
    ...
    info: { icon: 'M11.25 11.25l.041-.02a.75.75 0 011.063.852l-.708 2.836a.75.75 0 001.063.853l.041-.021M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9-3.75h.008v.008H12V8.25z', color: '#ff3b30' },
            ...
            <div className="flex flex-col gap-2 w-full mt-2">
              <button ref={confirmRef} onClick={onConfirm}
                className={`w-full py-3 rounded-2xl font-semibold text-sm transition-all active:scale-[0.98] ${
                  isDestructive ? 'bg-[#ff453a] text-white' : 'bg-primary-500 text-white'
                }`}
              >{confirmLabel}</button>

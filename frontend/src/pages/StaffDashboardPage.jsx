  ...
  return (
    <div className="pt-3 space-y-5 animate-fade-in pb-6">
      ...
      <div className="grid grid-cols-3 gap-2.5">
        {[
          { label: 'Today', value: today_checkins, color: 'text-blue-500' },
        ...
        <div className="space-y-2.5">
          ...
          {events.map((e, i) => (
            <button key={e.id} onClick={() => navigate(`/events/${e.id}`)}
              className="card w-full p-5 text-left active:scale-[0.98] transition-all animate-slide-up hover:border-blue-400"
